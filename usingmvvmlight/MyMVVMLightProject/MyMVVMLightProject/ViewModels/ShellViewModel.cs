...
using MyMVVMLightProject.Helpers;
...
namespace MyMVVMLightProject.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(new ShellNavigationItem("Shell_MasterDetail1".GetLocalized(), Symbol.Document, typeof(MasterDetail1ViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_Tabbed1".GetLocalized(), Symbol.Document, typeof(Tabbed1ViewModel).FullName));
        }
