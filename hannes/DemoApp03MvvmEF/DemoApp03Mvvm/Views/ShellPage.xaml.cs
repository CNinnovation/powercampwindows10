...
using DemoApp02Mvvm.Helpers;
using DemoApp02Mvvm.Services;
...
namespace DemoApp02Mvvm.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<Page2Page>("Shell_Page2".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<Page3Page>("Shell_Page3".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<Page4Page>("Shell_Page4".GetLocalized(), Symbol.Document));
