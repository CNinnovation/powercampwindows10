...
using LayoutUsingTemplateStudio.Helpers;
using LayoutUsingTemplateStudio.Services;

using Windows.UI.Xaml;
using Windows.UI.Xaml.Controls;
using Windows.UI.Xaml.Navigation;

namespace LayoutUsingTemplateStudio.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<MyTabbedPage>("Shell_MyTabbed".GetLocalized(), Symbol.Document));
